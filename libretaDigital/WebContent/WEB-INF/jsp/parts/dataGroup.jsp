	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<form id="idform" role="form" novalidate="" name="groupForm" class="text-left">
				<div class="form-group ">
					...
					<div>
						<input type="text" name="Name" class="form-control" ng-change="clearMsg()" placeholder="Nombre"
							ng-model="group.name" ng-model-options="{ updateOn: 'blur' }"></input>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div>
						<input type="text" name="Year" class="form-control" ng-change="clearMsg()" placeholder="Año"
							ng-model="group.year" ng-model-options="{ updateOn: 'blur' }"></input>
					</div>
				</div>
				...
				<div class="form-group text-right">
					<button class="btn btn-success " name="Add" value="Submit" ng-click="addGroup()"
						ng-disabled="groupForm.$invalid && addButton" ng-show="!editButton">Agregar</button>
		...
		<div class="col-md-6">
			<table st-table="groupsDisplayed" st-safe-src="groups" class="table table-striped table-hover">
				...
				<tbody>
					<tr ng-repeat="row in groupsDisplayed" st-select-row="row" st-select-mode="single"
